...
// Validasi nama
if (empty($_POST['nama'])) {
    echo "Nama masih kosong<br><a href='inputfoto.php'>Kembali</a>";
    exit;
}
...
if (!in_array($ekstensi, $valid)) {
    echo "Ekstensi tidak diperbolehkan<br><a href='inputfoto.php'>Kembali</a>";
    exit;
}

// Validasi ukuran (maks 1MB)
if ($ukuran > 10000000) {
    echo "Ukuran gambar terlalu besar (maks 10MB)<br><a href='inputfoto.php'>Kembali</a>";
    exit;
}

// Generate nama file baru
$namaBaru = rand(1000, 10000000) . "." . $ekstensi;
...
if (move_uploaded_file($tmp, $direktori . $namaBaru)) {
    ...
    if (mysqli_query($koneksi, $query)) {
        ...
        echo "<br><a href='tampil.php'>Lihat Halaman Berikutnya</a>";
    } else {
        echo "Gagal menyimpan ke database: " . mysqli_error($koneksi);
    }

} else {
    echo "Gagal upload file<br><a href='inputfoto.php'>Kembali</a>";
}
?>